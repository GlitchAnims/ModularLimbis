		...
		private void Consequence(string section)
		{
			...
			switch (mEth)
			{
				case "log":
					...
					break;
				case "base":
					skillPowerAdder = GetNumFromParamString(circledSection);
					break;
				case "final":
					skillPowerResultAdder = GetNumFromParamString(circledSection);
					break;
				case "clash":
					parryingResultAdder = GetNumFromParamString(circledSection);
					break;
				case "scale":
					{
						if (circles.Length == 1)
					...
					break;
				case "dmgadd":
					atkDmgAdder = GetNumFromParamString(circledSection);
					break;
				case "dmgmult":
					atkMultAdder = GetNumFromParamString(circledSection);
					break;
				case "mpdmg":
					{
				...
				case "setdata":
					...
					break;
				case "changeskill":
					if (modsa_selfAction != null) modsa_selfAction.TryChangeSkill(GetNumFromParamString(circledSection));
					break;
				case "setimmortal":
					{
				...
				case "skillsend":
					...
					break;
				case "skillreuse":
					foreach (BattleUnitModel targetModel in GetTargetModelList(circledSection)) targetModel.ReuseAction(modsa_selfAction);
					break;
		...
		private void AcquireValue(int setvalue_idx, string section)
		{
			...
			switch (methodology)
			{
				...
				case "bufcheck":
					...
					break;
				case "getdmg":
					valueList[setvalue_idx] = lastFinalDmg;
					break;
				case "round":
					{
				...
				case "wave":
					...
					break;
				case "activations":
					valueList[setvalue_idx] = activationCounter;
					break;
				case "unitstate":
					{
						BattleUnitModel targetModel = GetTargetModel(circledSection);
				...
				case "deadallies":
					...
					break;
				case "trieddeath":
					valueList[setvalue_idx] = immortality_attempted ? 1 : 0;
					break;
				case "random":
					{
